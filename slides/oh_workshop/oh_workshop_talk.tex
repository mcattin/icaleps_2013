...
\date[OH Workshop] %(optional, should be abbreviation of conference name)
...
\begin{frame}{Beams Controls standard kit}
  ...
  \begin{block}{Currently, September 2013}
    \begin{itemize}
    \item
      About 120 module types % -- with just a few engineers
    \item
    ...
    %%   \begin{itemize}
    %%   \item
    %%     Can maintain existing installations with a limited stock
    %%   \item
    %%     No re-ordering or production possible
    %%   \item
    %%     Mostly because of obsolete components
    %%   \end{itemize}
    \end{itemize}
  \end{block}
