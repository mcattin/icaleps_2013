...
\begin{frame}
  ...
  \note[item]{I'm going to talk about the CERN's FMC kit.}
\end{frame}
...
\begin{frame}{Outline}
  ...
  \note[item]{Then I'll explain why and how we used open hardware to develop the new kit and also share a bit of our experience with open hardware.}
